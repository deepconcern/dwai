...
export type GetCharacterClassesForCreateQuery = { characterClasses: { all: Array<{ bonds: Array<string>, damageDie: number, hpBase: number, key: string, name: string, alignmentTemplates: Array<{ alignment: string, description: string }>, lookExamples: Array<{ examples: Array<string>, type: string }>, raceMoves: Array<{ key: string, name: string, trigger: string, type: string }>, startingMoves: Array<{ key: string, name: string, trigger: string, type: string }> }> } };

export type GetMovesForCreateQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMovesForCreateQuery = { moves: { all: Array<{ key: string, name: string, trigger: string, type: string }> } };
...
export const GetMovesForCreateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMovesForCreate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moves"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"all"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"trigger"}},{"kind":"Field","name":{"kind":"Name","value":"type"}}]}}]}}]}}]} as unknown as DocumentNode<GetMovesForCreateQuery, GetMovesForCreateQueryVariables>;
