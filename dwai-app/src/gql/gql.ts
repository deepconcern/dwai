 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateCharacter($input: CreateCharacterInput!) {\n    characters {\n        create(input: $input) {\n            id\n            name\n        }\n    }\n}"): (typeof documents)["mutation CreateCharacter($input: CreateCharacterInput!) {\n    characters {\n        create(input: $input) {\n            id\n            name\n        }\n    }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
