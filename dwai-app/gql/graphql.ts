...
export type CreateCharacterInput = {
  ...
  moveCreationOptionChoices: Array<MoveCreationOptionChoiceInput>;
...
export type MoveCreationOptionChoiceInput = {
...
export type GetCharacterQuery = { characters: { byId: { id: string, name: string, abilities: Array<{ ability: Ability, modifier: number, score: number }>, looks: Array<{ id: string, value: string, lookType: { key: string, name: string } }> } } };
...
export type GetCharacterClassesForCreateQuery = { characterClasses: { all: Array<{ bonds: Array<string>, damageDie: number, hpBase: number, key: string, name: string, alignmentTemplates: Array<{ alignment: string, description: string }>, lookExamples: Array<{ examples: Array<string>, type: string }>, raceMoves: Array<(
        ...
        { key: string }
        & { ' $fragmentRefs'?: { 'MoveFragmentFragment': MoveFragmentFragment } }
      )> }> }, lookTypes: { all: Array<{ examples: Array<string>, key: string, name: string }> } };
...
export type MoveFragmentFragment = { description: string | null, key: string, name: string, on10: string | null, on7to9: string | null, onMiss: string | null, options: Array<string>, replacesKey: string | null, requiresKey: string | null, roll: string | null, trigger: string | null, type: string, creationOptions: Array<{ label: string, pick: number, choices: Array<{ key: string, label: string }> }> } & { ' $fragmentName'?: 'MoveFragmentFragment' };
